          ...
          <>
            ...
            <div className="space-y-10">
              ...
              <section className="pb-8 border-b border-zinc-800">
                ...
                <p>통신판매업 신고번호:제 2026-인천미추홀-0274호</p>
              ...
              <section className="pb-8 border-b border-zinc-800">
                ...
                <p>회사는 일부 기능을 베타(Beta) 형태로 제공할 수 있으며,
베타 기능의 세부 조건은 별도 정책 또는 안내에 따릅니다.</p>
              </section>
...
<section className="pb-8 border-b border-zinc-800">
  ...
  <p>
    회사는 일부 기능을 베타(Beta) 형태로 제공할 수 있습니다.
  </p>

  <p>
    베타 기능은 정식 서비스 이전의 시험적 기능으로,
    기능 안정성, 지속성, 성능 등이 완전히 보장되지 않을 수 있습니다.
  </p>

  <p>
    회사는 운영 정책 또는 기술적 사유에 따라 베타 기능의 내용,
    제공 범위, 이용 조건을 변경하거나 제공을 중단할 수 있습니다.
  </p>

  <p>
    무료 플랜에서는 베타 기능의 사용량 또는 기능이 일부 제한될 수 있으며,
    유료 플랜에서는 별도의 정책에 따라 이용 범위가 확대될 수 있습니다.
  </p>

  <p>
    베타 기능 이용 중 발생할 수 있는 오류, 데이터 손실,
    서비스 중단 등으로 인한 손해에 대하여
              ...
              <section className="pb-8 border-b border-zinc-800">
                ...
                <div className="pl-4 space-y-2 mt-6">
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>
본 서비스는 Google 유료 계정 기반의 외부 API가 정상적으로 연결된 환경에서 사용되는 것을 전제로 합니다.
무료 계정 사용, API 할당량 초과, 결제 미등록, 키 설정 오류 등
이용 환경 요건을 충족하지 않아 발생한 오류는 회사의 책임 사유에 해당하지 않으며,
이를 사유로 한 환불은 제한될 수 있습니다.
</li>

<li>
환불 검토 과정에서 서비스 이용 당시의 API 설정 상태,
Google 계정 결제 등록 여부 및 사용 기록 등을 확인할 수 있으며,
해당 확인이 어려운 경우 환불이 제한될 수 있습니다.
</li>
                  </ul>
                  <p className="mt-4">
외부 API 사용과 관련된 책임 범위는 제7조(개인 API 키 사용)에 따릅니다.
</p>
                </div>
              </section>
              ...
              <section className="pb-8 border-b border-zinc-800">
                ...
                <p>
본 서비스는 Google 유료 결제 계정이 정상적으로 등록된 환경에서의 사용을 전제로 하며,
무료 계정 또는 결제 미등록 상태에서 발생하는 할당량 제한, 기능 제한,
과금 오류 등은 회사의 책임 범위에 포함되지 않습니다.
</p>
